...
void VSy_Calc(void)
{
	...
	{/*
		...
		*/
		case 0:Vs_S3=0;Vs_S5=1;Vs_S7=1;Vs_S9=1;Vs_S10=1;Vs_S8=1;Vs_S6=1;Vs_S4=1;Vs_rec=1;break;
		...
		case 4:Vs_S3=1;Vs_S5=1;Vs_S7=1;Vs_S9=1;Vs_S10=0;Vs_S8=1;Vs_S6=1;Vs_S4=1;Vs_rec=0;break;
...
void Futaba_VFD_Init(void)
{
  ...
  vfd_send_cmd2(0x00,0x00);//DISPLAY_MODE
 	vfd_send_cmd2(0xe4,0x80);//DIMING 0-240
  ...
  vfd_send_data(0X60);//地址		相对	绝对
	...
	vfd_send_data(0X00);//TIME		01H		0X61	0X02:ON 0X00:0FF
	vfd_send_data(0X00);//SHIFT		02H		0X62
	vfd_send_data(0X00);//CLOCK		03H		0X63
	vfd_send_data(0X00);//HD			04H		0X64
	vfd_send_data(0X00);//USB			05H		0X65
	vfd_send_data(0X00);//LOCK		06H		0X66	
	vfd_send_data(0X00);//DOLBY		07H		0X67	
	vfd_send_data(0X00);//MUTE		08H		0X68
	vfd_send_data(0X00);//TU1			09H		0X69
	vfd_send_data(0X00);//TU2			0AH		0X6A
	vfd_send_data(0X00);//MP3			0BH		0X6B
	vfd_send_data(0X00);//LOOP		0CH		0X6C
